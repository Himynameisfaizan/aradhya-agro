...
<head>
  ...
  <meta name="description"
    content="100% pure, cold-pressed Kachchi Ghani mustard oil exported worldwide from Aradhya Agro Industries, India.">
...
<body>
  ...
  <style>
    ...
    .slide-overlay {
      position: absolute;
      inset: 0;
      background: linear-gradient(90deg, rgba(251, 243, 222, 0.95) 40%, rgba(251, 243, 222, 0.4) 100%);
      z-index: 2;
    }
    ...
    .seal {
      ...
      height: 132px;
      border-radius: 50%;
      background: radial-gradient(circle at 35% 30%, #F6D97A 0%, var(--gold-bright) 45%, var(--gold) 100%);
      border: 3px solid #fff;
      box-shadow: 0 8px 24px rgba(122, 30, 43, .35), 0 0 0 6px rgba(255, 255, 255, .55) inset;
      display: flex;
      align-items: center;
    ...
    .seal::before {
      ...
      inset: -10px;
      border-radius: 50%;
      border: 2px dashed rgba(122, 30, 43, .45);
    }
    ...
    @media (max-width:991px) {
      .slide-overlay {
        background: linear-gradient(180deg, rgba(251, 243, 222, 0.95) 60%, rgba(251, 243, 222, 0.8) 100%);
      }
    ...
    .teaser-img {
      ...
      box-shadow: 0 20px 40px rgba(42, 33, 20, .25);
      width: 100%;
    }
          ...
          <div class="container hero-container">
            <div class="row align-items-center">
              <div class="col-lg-6 hero-copy">
                ...
                <p class="lead">100% pure, cold-pressed (Kachchi Ghani) mustard oil — sourced directly from farmers,
                  free from chemicals.</p>
                <div class="d-flex flex-wrap gap-3 mt-4">
                  <a href="products.php" class="btn btn-danger btn-lg rounded-pill px-4"
                    style="background-color:var(--maroon); border:none;">View Products</a>
              ...
              <div class="col-lg-6">
                <div class="hero-figure">
                  <div class="seal">Purity<br><small>100% Guarantee</small></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container hero-container">
            <div class="row align-items-center">
              <div class="col-lg-6 hero-copy">
                ...
                <p class="lead">Our mustard seeds are slow-crushed in traditional wooden churners at low temperatures,
                  preserving all natural goodness.</p>
                <div class="d-flex flex-wrap gap-3 mt-4">
                  <a href="manufacturing.php" class="btn btn-danger btn-lg rounded-pill px-4"
                    style="background-color:var(--maroon); border:none;">See Our Process</a>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="hero-figure">
                  <div class="seal">Kachchi<br><small>Ghani</small></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-7 teaser-content">
          ...
          <p>A personal health scare revealed a shocking truth — finding genuinely pure mustard oil had become nearly
            impossible. Aradhya Agro Industries was founded on this revelation, operating on a direct farmer-to-consumer
            model while now serving international markets with the same rural authenticity.</p>
  ...
  <section class="section-pad teaser-section" id="process" style="background:var(--cream-deep);">
    <div class="container">
      ...
      <div class="why-mini-grid">
        <div class="why-mini"><i class="bi bi-flower2"></i>
          <h3>Mustard Harvest</h3>
          <p>Fresh seeds sourced directly from trusted farmers.</p>
        </div>
        <div class="why-mini"><i class="bi bi-gear-wide-connected"></i>
          <h3>Cold Pressing</h3>
          <p>Slow-crushed in traditional wooden churners.</p>
        </div>
        <div class="why-mini"><i class="bi bi-box-seal"></i>
          <h3>Export Packing</h3>
          <p>Hygienic, food-grade, international-standard packaging.</p>
        </div>
      </div>
      <div class="text-center mt-4">
        <a href="manufacturing.php" class="link-arrow">See the full manufacturing process <i
  ...
  <section class="section-pad" id="products">
    <div class="container">
      ...
      <div class="text-center mt-4">
        <a href="products.php" class="link-arrow">View all products &amp; specifications <i
            class="bi bi-arrow-right"></i></a>
      </div>
    </div>
  </section>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3">
          <div class="info-card">
            ...
            <p>No adulteration, no preservatives — just pure, natural mustard oil.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="info-card">
            <div class="icon-wrap"><i class="bi bi-people"></i></div>
            <h3>500+ Farmer Partners</h3>
            <p>Direct sourcing, fair prices, no middlemen.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="info-card">
            ...
            <p>FSSAI, ISO 22000, and Startup India recognised.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="info-card">
            ...
            <h3>15+ Countries</h3>
            <p>Experienced in export logistics and documentation.</p>
          </div>
        </div>
      </div>
      <div class="text-center mt-4">
  ...
  <section class="section-pad" style="background:var(--cream-deep);">
    <div class="container">
      <div class="cta-band">
        ...
        <p>Whether you need a trial pack, a bulk order, or want to become a distributor — our team responds within 24
          hours.</p>
